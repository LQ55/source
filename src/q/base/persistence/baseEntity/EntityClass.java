package q.base.persistence.baseEntity;
...
import q.base.annotation.Entity;
import q.base.util.Symbol;
...
public class EntityClass <T extends Entity>{
	 ...
	 * @throws SQLException 
	 */
	public static PreparedStatement fillInsertParameters(PreparedStatement preparedStatement,q.base.persistence.baseEntity.Entity entity) 
	 ...
	 * @return
	 */
	public static q.base.persistence.baseEntity.Entity setDefaultPerameters(q.base.persistence.baseEntity.Entity entity){
	...
	private static String createDeleteSQL(Class<? extends q.base.persistence.baseEntity.Entity> clazz){
